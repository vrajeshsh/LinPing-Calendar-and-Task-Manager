...
export default function Home() {
  ...
  const { schedules, initializeDayFromTemplate, rolloverIncompleteTasks, purgeOldArchived } = useScheduleStore();
  ...
  useEffect(() => {
    ...
    // Run rollover and archive cleanup once per day
    rolloverIncompleteTasks();
    purgeOldArchived();
  }, [today, initializeDayFromTemplate, rolloverIncompleteTasks, purgeOldArchived]);
