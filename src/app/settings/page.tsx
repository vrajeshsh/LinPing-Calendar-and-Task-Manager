...
export default function SettingsPage() {
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 px-4 md:px-8 max-w-2xl w-full mx-auto pb-32">
        ...
        <div className="bg-card/60 border border-border/30 rounded-2xl p-5 shadow-sm mt-4">
          <h2 className="font-semibold text-base mb-1">About</h2>
          <p className="text-muted-foreground text-sm">LinPing AI Calendar · v2.0</p>
          <p className="text-muted-foreground text-xs mt-1">Powered by OpenRouter · Built with Next.js 16</p>
        </div>
      </div>
    </div>
  );
